...
const extensionProducts = [
  ...
  },
  {
    ...
    rating: 4.8,
    reviews: 156,
    description: "Natural yaki straight texture, 16 inches"
  },
  {
    id: "ext-6",
    title: "Raw Burmese Curls",
    price: 259.99,
    originalPrice: 299.99,
    imageUrl: "https://images.unsplash.com/photo-1531297484001-80022131f5a1?w=400&h=400&fit=crop",
    rating: 4.9,
    reviews: 112,
    description: "Authentic raw Burmese curly hair, 20 inches"
  },
  {
    id: "ext-7",
    title: "Raw Cambodian Curls",
    price: 249.99,
    originalPrice: 289.99,
    imageUrl: "https://images.unsplash.com/photo-1544005313-94ddf0286df2?w=400&h=400&fit=crop",
    rating: 4.8,
    reviews: 98,
    description: "Premium raw Cambodian curly hair, 18 inches"
  }
];
...
const HairExtensionsContent = () => {
  ...
  const handleAddToCart = (product: typeof extensionProducts[0]) => {
    addItem({
      id: product.id,
      title: product.title,
      price: product.price,
    ...
    <section className="py-16">
      <div className="container mx-auto px-4">
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-gray-800 mb-4">Hair Extensions Collection</h1>
          <p className="text-gray-600 max-w-2xl mx-auto">
            Add length, volume, and style with our premium hair extensions. From clip-ins to tape-ins, 
            find the perfect match for your hair goals.
          </p>
        </div>
...
export default HairExtensionsContent;
